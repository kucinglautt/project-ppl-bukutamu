...
<?= $this->section('content'); ?>/
    ...
    <title>Sistem Informasi Buku Tamu - Forgot Password</title>
                            ...
                            <div class="col">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <p class="mb-2">Tolong hubungi admin pada email berikut</p>
                                        <p class="mb-3"><b>example.email@email.com</b></p>
                                    </div>
                                    <form class="user">
                                    <hr>
                                    <div class="text-center">
