...
class GantiPasswordPetugasController extends Controller
{
    public function index()
    {
        return view('petugas/gantiPassword');
    }
    ...
    public function update()
    {
        ...
        return redirect()->to('/dashboard-petugas')->with('Pesan', 'Password berhasil diubah.');
    }
}
